...
try {
  ...
  if (fs.existsSync(envFilePath)) {
    console.log('⚠️  .env file already exists. Backing up existing file...');
  ...
  console.log('');
  console.log('🚀 You can now start the frontend server with: npm run dev');
  console.log('');
  console.log('⚠️  IMPORTANT: If you\'re still having authentication issues after this:');
